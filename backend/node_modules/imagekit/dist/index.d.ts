...
declare class ImageKit {
    ...
    verifyWebhookEvent: (payload: string | Uint8Array, signature: string, secret: string) => {
        timestamp: number;
        event: import("imagekit/dist/libs/interfaces").WebhookEvent;
    };
}
export = ImageKit;
